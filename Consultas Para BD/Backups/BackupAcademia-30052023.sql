...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações nesse BD.';
...
-- Copiando dados para a tabela academia.itemvenda: ~1 rows (aproximadamente)
...
BEGIN
	...
	WHERE v.CLIENTES_codCLIENTES = codClientePesquisar;
