...
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela agencia3si2023.auditoria: ~35 rows (aproximadamente)
...
INSERT INTO `auditoria` (`codAuditoria`, `acao`, `tabela`, `dataHora`, `usuario`) VALUES
	...
	(75, 'Nome do cliente: ARTHUR foi alterado para maiusculo', 'cliente', '2023-05-09 10:12:30', 'root@localhost'),
	(76, 'Conta iserida: 22. Com tipo: Poupança. Saldo de: 0.01', 'conta', '2023-05-09 10:12:30', 'root@localhost'),
	(77, 'Nome do cliente: ARTHUR FRANCO foi alterado para maiusculo', 'cliente', '2023-05-09 10:13:03', 'root@localhost'),
	(78, 'Conta iserida: 23. Com tipo: Poupança. Saldo de: 0.01', 'conta', '2023-05-09 10:13:03', 'root@localhost'),
	(79, 'Inserção de cliente menor de idade: ARTHUR FRANCO', 'cliente', '2023-05-09 10:13:03', 'root@localhost'),
	(80, 'Exclusão de conta do cliente: ARTHUR', 'contavinculada', '2023-05-09 10:16:47', 'root@localhost');
...
INSERT INTO `cliente` (`idCLIENTE`, `nome`, `cpf`, `rg`, `dataNascimento`, `telefone`) VALUES
	...
	(60, 'ARTHUR FRANCO', '052.249.572-66', NULL, '2010-07-03', NULL);
...
INSERT INTO `conta` (`idCONTA`, `tipo`, `saldo`, `senha`) VALUES
	...
	(8, 'Poupança', 0.01, 'abc'),
	(9, 'Poupança', 0.01, 'abc'),
	(22, 'Poupança', 0.01, 'abc'),
	(23, 'Poupança', 0.01, 'abc');
