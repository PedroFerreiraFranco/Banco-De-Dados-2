...
-- Copiando dados para a tabela lanchonete3si_2023.auditoria: ~1 rows (aproximadamente)
...
INSERT INTO `produto` (`codProduto`, `nome`, `precoCusto`, `precoVenda`, `margemLucro`, `dataValidade`, `quantidadeEstoque`, `quantidadeMinima`, `CATEGORIA_codCategoria`, `MARCA_codMarca`) VALUES
	(1, 'Empada de Palmito', 1.80, 3.60, 100.00, '2022-11-20', 19.00, 10.00, 1, 6),
	(2, 'Prestigio', 2.00, 3.00, NULL, '2023-12-11', 50.00, 15.00, 6, 1),
	(3, 'Guaraná 600ml', 2.00, 3.50, NULL, '2023-05-21', 45.00, 20.00, 4, 5);
