...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações nesse BD.';

-- Copiando dados para a tabela academia.auditoria: ~8 rows (aproximadamente)
...
-- Copiando dados para a tabela academia.cargos: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela academia.produtos: ~0 rows (aproximadamente)
