...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela agencia3si2023.auditoria: ~31 rows (aproximadamente)
...
-- Copiando dados para a tabela agencia3si2023.cliente: ~18 rows (aproximadamente)
