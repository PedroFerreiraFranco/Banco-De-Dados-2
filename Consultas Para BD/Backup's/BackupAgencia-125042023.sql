...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela agencia3si2023.auditoria: ~26 rows (aproximadamente)
...
-- Copiando dados para a tabela agencia3si2023.cliente: ~17 rows (aproximadamente)
...
-- Copiando dados para a tabela agencia3si2023.conta: ~3 rows (aproximadamente)
