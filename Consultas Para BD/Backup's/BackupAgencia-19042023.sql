...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela agencia3si2023.auditoria: ~7 rows (aproximadamente)
...
-- Copiando dados para a tabela agencia3si2023.cliente: ~16 rows (aproximadamente)
